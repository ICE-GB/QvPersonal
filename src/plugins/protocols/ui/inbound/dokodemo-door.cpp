...
DokodemoDoorInboundEditor::DokodemoDoorInboundEditor(QWidget *parent) : Qv2rayPlugin::Gui::QvPluginEditor(parent)
{
    setupUi(this);
...
void DokodemoDoorInboundEditor::SetContent(const IOProtocolSettings &content)
{
...
const IOProtocolSettings DokodemoDoorInboundEditor::GetContent() const
{
    return content;
}
